...
if __name__ == '__main__':
    ...
    parser.add_argument('--category', type=str, default='cotton', help='select category')
    parser.add_argument('--npoints', type=int, default=20000, help='resample points number')
    ...
    dataset = PartNormalDataset(root = root, npoints=99999, split='test', normal_channel=False)
